...
<Info><h3>Accessing your API Keys</h3>To get access to your own Application ID & API Keys, go to <a href="https://dashboard.algolia.com/account/api-keys/all" target="_blank">API Keys</a> page with Algolia. Alternatively, you can interact with the Algolia CLI to get your information.</Info>
